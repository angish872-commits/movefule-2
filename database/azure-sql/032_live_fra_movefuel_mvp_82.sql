...
-- Project: fra / movefule (6a6cc4b20007b4445e93)
-- Database: movefuel_mvp (MoveFuel MVP)
-- Tables: 82
...
-- Totals: 82 tables, 780 columns, 166 indexes
...
-- ============================================================
-- TABLE audit_event (Audit events)
-- Appwrite name: Audit events | enabled=True rowSecurity=True bytesUsed=37437.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_calendar_entry_calendar_entry_rev_identity_uq' AND object_id=OBJECT_ID(N'dbo.calendar_entry')) CREATE UNIQUE INDEX [IX_calendar_entry_calendar_entry_rev_identity_uq] ON dbo.[calendar_entry] ([calendarRevisionId], [entryId]);
GO
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_calendar_entry_calendar_entry_user_sem_rev' AND object_id=OBJECT_ID(N'dbo.calendar_entry')) CREATE INDEX [IX_calendar_entry_calendar_entry_user_sem_rev] ON dbo.[calendar_entry] ([userId], [semanticObjectType], [semanticObjectId], [calendarRevision]);
GO
...
-- ============================================================
-- TABLE consent_record (Consent records)
-- Appwrite name: Consent records | enabled=True rowSecurity=True bytesUsed=3136.0
-- ============================================================
...
-- Appwrite name: Daily recommendation | enabled=True rowSecurity=True bytesUsed=21197.0
-- ============================================================
...
-- ============================================================
-- TABLE daily_summary (Daily summaries)
-- Appwrite name: Daily summaries | enabled=True rowSecurity=True bytesUsed=2777.0
-- ============================================================
...
-- Appwrite name: Devices | enabled=True rowSecurity=True bytesUsed=35905.0
-- ============================================================
...
-- Appwrite name: Device command | enabled=True rowSecurity=True bytesUsed=3784.0
-- ============================================================
...
-- ============================================================
-- TABLE device_session (Device sessions)
-- Appwrite name: Device sessions | enabled=True rowSecurity=True bytesUsed=3269.0
-- ============================================================
...
-- Appwrite name: Exercise catalog | enabled=True rowSecurity=True bytesUsed=54471.0
-- ============================================================
...
-- ============================================================
-- TABLE exercise_library (Exercise Library)
-- Appwrite name: Exercise Library | enabled=True rowSecurity=False bytesUsed=5255.0
-- ============================================================

IF OBJECT_ID(N'dbo.exercise_library',N'U') IS NULL
BEGIN
  CREATE TABLE dbo.[exercise_library] (
    [exerciseId] NVARCHAR(128) NOT NULL CONSTRAINT [PK_exercise_library] PRIMARY KEY,
    [slug] NVARCHAR(128) NOT NULL,
    [name] NVARCHAR(256) NOT NULL,
    ...
    [primaryMusclesJson] NVARCHAR(MAX) NULL,
    [secondaryMusclesJson] NVARCHAR(MAX) NULL,
    [instructionsJson] NVARCHAR(MAX) NULL,
    [video] NVARCHAR(256) NULL,
    [status] NVARCHAR(32) NOT NULL
  );
END;
GO
...
-- ============================================================
-- TABLE idempotency_key (Idempotency keys)
-- Appwrite name: Idempotency keys | enabled=True rowSecurity=True bytesUsed=4801.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_idempotency_key_scope_keyHash_unique' AND object_id=OBJECT_ID(N'dbo.idempotency_key')) CREATE UNIQUE INDEX [IX_idempotency_key_scope_keyHash_unique] ON dbo.[idempotency_key] ([scope], [keyHash]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_idempotency_key_expiresAt' AND object_id=OBJECT_ID(N'dbo.idempotency_key')) CREATE INDEX [IX_idempotency_key_expiresAt] ON dbo.[idempotency_key] ([expiresAt]);
GO

-- ============================================================
-- TABLE meal (Confirmed meals)
-- Appwrite name: Confirmed meals | enabled=True rowSecurity=True bytesUsed=2627.0
-- ============================================================
...
-- ============================================================
-- TABLE meal_analysis_request (Meal analysis requests)
-- Appwrite name: Meal analysis requests | enabled=True rowSecurity=True bytesUsed=3527.0
-- ============================================================
...
-- ============================================================
-- TABLE meal_draft (Meal drafts)
-- Appwrite name: Meal drafts | enabled=True rowSecurity=True bytesUsed=3775.0
-- ============================================================
...
-- ============================================================
-- TABLE meal_draft_revision (Meal draft revisions)
-- Appwrite name: Meal draft revisions | enabled=True rowSecurity=True bytesUsed=2641.0
-- ============================================================
...
-- ============================================================
-- TABLE meal_item (Meal items)
-- Appwrite name: Meal items | enabled=True rowSecurity=True bytesUsed=20162.0
-- ============================================================
...
-- ============================================================
-- TABLE meal_revision (Meal revisions)
-- Appwrite name: Meal revisions | enabled=True rowSecurity=True bytesUsed=2641.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_meal_revision_userId_mealId_revision_unique' AND object_id=OBJECT_ID(N'dbo.meal_revision')) CREATE UNIQUE INDEX [IX_meal_revision_userId_mealId_revision_unique] ON dbo.[meal_revision] ([userId], [mealId], [revision]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_meal_revision_userId_createdAt' AND object_id=OBJECT_ID(N'dbo.meal_revision')) CREATE INDEX [IX_meal_revision_userId_createdAt] ON dbo.[meal_revision] ([userId], [createdAt]);
GO
...
-- Appwrite name: Model configuration | enabled=True rowSecurity=True bytesUsed=10968.0
-- ============================================================
...
-- ============================================================
-- TABLE privacy_preference (Privacy preferences)
-- Appwrite name: Privacy preferences | enabled=True rowSecurity=True bytesUsed=1735.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_serving_prior_observation_serving_prior_owner_obs_unique' AND object_id=OBJECT_ID(N'dbo.serving_prior_observation')) CREATE UNIQUE INDEX [IX_serving_prior_observation_serving_prior_owner_obs_unique] ON dbo.[serving_prior_observation] ([ownerUserId], [observationId]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_serving_prior_observation_serving_prior_source_rev_unique' AND object_id=OBJECT_ID(N'dbo.serving_prior_observation')) CREATE UNIQUE INDEX [IX_serving_prior_observation_serving_prior_source_rev_unique] ON dbo.[serving_prior_observation] ([ownerUserId], [sourceMealId], [sourceMealRevision], [identityKey]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_serving_prior_observation_serving_prior_owner_ident_confirmed' AND object_id=OBJECT_ID(N'dbo.serving_prior_observation')) CREATE INDEX [IX_serving_prior_observation_serving_prior_owner_ident_confirmed] ON dbo.[serving_prior_observation] ([ownerUserId], [identityKey], [confirmedAt]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_serving_prior_observation_serving_prior_owner_confirmed' AND object_id=OBJECT_ID(N'dbo.serving_prior_observation')) CREATE INDEX [IX_serving_prior_observation_serving_prior_owner_confirmed] ON dbo.[serving_prior_observation] ([ownerUserId], [confirmedAt]);
GO
...
-- ============================================================
-- TABLE sync_cursor (Sync cursor)
-- Appwrite name: Sync cursor | enabled=True rowSecurity=True bytesUsed=4928.0
-- ============================================================
...
-- ============================================================
-- TABLE sync_operation (Sync operations)
-- Appwrite name: Sync operations | enabled=True rowSecurity=True bytesUsed=5829.0
-- ============================================================
...
-- ============================================================
-- TABLE target_revision (Target revisions)
-- Appwrite name: Target revisions | enabled=True rowSecurity=True bytesUsed=2905.0
-- ============================================================
...
BEGIN
  CREATE TABLE dbo.[target_revision] (
    ...
    [source] NVARCHAR(32) NOT NULL,
    [formulaVersion] NVARCHAR(64) NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_target_revision_user_effective_revision_unique' AND object_id=OBJECT_ID(N'dbo.target_revision')) CREATE UNIQUE INDEX [IX_target_revision_user_effective_revision_unique] ON dbo.[target_revision] ([userId], [effectiveDate], [revision]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_target_revision_userId_effectiveDate' AND object_id=OBJECT_ID(N'dbo.target_revision')) CREATE INDEX [IX_target_revision_userId_effectiveDate] ON dbo.[target_revision] ([userId], [effectiveDate]);
GO
...
-- ============================================================
-- TABLE user_goal (User goals)
-- Appwrite name: User goals | enabled=True rowSecurity=True bytesUsed=2759.0
-- ============================================================
...
-- ============================================================
-- TABLE user_preference (User preferences)
-- Appwrite name: User preferences | enabled=True rowSecurity=True bytesUsed=35391.0
-- ============================================================
...
-- Appwrite name: Watch deliveries | enabled=True rowSecurity=True bytesUsed=3277.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_watch_delivery_delivery_user_summary_rev_uq' AND object_id=OBJECT_ID(N'dbo.watch_delivery')) CREATE UNIQUE INDEX [IX_watch_delivery_delivery_user_summary_rev_uq] ON dbo.[watch_delivery] ([userId], [deviceId], [summaryId], [revision]);
GO
...
-- Appwrite name: Watch receipts | enabled=True rowSecurity=True bytesUsed=3270.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_watch_receipt_receipt_user_summary_rev_outcome_uq' AND object_id=OBJECT_ID(N'dbo.watch_receipt')) CREATE UNIQUE INDEX [IX_watch_receipt_receipt_user_summary_rev_outcome_uq] ON dbo.[watch_receipt] ([userId], [deviceId], [summaryId], [revision], [outcome]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_watch_receipt_userId_updatedAt' AND object_id=OBJECT_ID(N'dbo.watch_receipt')) CREATE INDEX [IX_watch_receipt_userId_updatedAt] ON dbo.[watch_receipt] ([userId], [updatedAt]);
GO
...
-- Appwrite name: Workout event | enabled=True rowSecurity=True bytesUsed=36674.0
-- ============================================================
...
-- Appwrite name: Workout plan revision | enabled=True rowSecurity=True bytesUsed=35520.0
-- ============================================================
...
-- Appwrite name: Workout plan step | enabled=True rowSecurity=True bytesUsed=3681.0
-- ============================================================
...
-- Appwrite name: Workout session revision | enabled=True rowSecurity=True bytesUsed=5313.0
-- ============================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_workout_session_revision_sessionId_revision_unique' AND object_id=OBJECT_ID(N'dbo.workout_session_revision')) CREATE UNIQUE INDEX [IX_workout_session_revision_sessionId_revision_unique] ON dbo.[workout_session_revision] ([sessionId], [revision]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_workout_session_revision_sessionId_idempotencyKey_unique' AND object_id=OBJECT_ID(N'dbo.workout_session_revision')) CREATE UNIQUE INDEX [IX_workout_session_revision_sessionId_idempotencyKey_unique] ON dbo.[workout_session_revision] ([sessionId], [idempotencyKey]);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_workout_session_revision_sessionId_occurredAt' AND object_id=OBJECT_ID(N'dbo.workout_session_revision')) CREATE INDEX [IX_workout_session_revision_sessionId_occurredAt] ON dbo.[workout_session_revision] ([sessionId], [occurredAt]);
GO
