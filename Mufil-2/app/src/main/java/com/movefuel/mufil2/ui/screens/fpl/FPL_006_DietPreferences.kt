...
@Composable
fun FPL006DietPreferencesScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_006",
        title = "Diet Preferences",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_007,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_005,
...
@Composable
private fun FPL006DietPreferencesScreenPreview() {
    MoveFuelTheme { FPL006DietPreferencesScreen {} }
}
