...
@Composable
fun FPL005PlanPreferencesScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_005",
        title = "Plan Preferences",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_006,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_004,
...
@Composable
private fun FPL005PlanPreferencesScreenPreview() {
    MoveFuelTheme { FPL005PlanPreferencesScreen {} }
}
