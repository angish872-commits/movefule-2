...
@Composable
fun FPL007AllergyRulesScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_007",
        title = "Allergy Rules",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_008,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_006,
...
@Composable
private fun FPL007AllergyRulesScreenPreview() {
    MoveFuelTheme { FPL007AllergyRulesScreen {} }
}
