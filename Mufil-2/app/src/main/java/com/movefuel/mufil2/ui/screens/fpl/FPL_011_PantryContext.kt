...
@Composable
fun FPL011PantryContextScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_011",
        title = "Pantry Context",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_012,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_010,
...
@Composable
private fun FPL011PantryContextScreenPreview() {
    MoveFuelTheme { FPL011PantryContextScreen {} }
}
