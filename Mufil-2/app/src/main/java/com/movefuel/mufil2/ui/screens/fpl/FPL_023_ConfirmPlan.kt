...
@Composable
fun FPL023ConfirmPlanScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_023",
        title = "Confirm Plan",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_024,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_022,
...
@Composable
private fun FPL023ConfirmPlanScreenPreview() {
    MoveFuelTheme { FPL023ConfirmPlanScreen {} }
}
