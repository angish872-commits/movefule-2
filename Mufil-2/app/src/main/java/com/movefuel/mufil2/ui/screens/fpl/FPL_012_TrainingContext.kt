...
@Composable
fun FPL012TrainingContextScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_012",
        title = "Training Context",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_013,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_011,
...
@Composable
private fun FPL012TrainingContextScreenPreview() {
    MoveFuelTheme { FPL012TrainingContextScreen {} }
}
