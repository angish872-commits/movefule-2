...
@Composable
fun FPL008CuisinePreferencesScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_008",
        title = "Cuisine Preferences",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_009,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_007,
...
@Composable
private fun FPL008CuisinePreferencesScreenPreview() {
    MoveFuelTheme { FPL008CuisinePreferencesScreen {} }
}
