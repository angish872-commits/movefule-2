...
@Composable
fun FPL009CookingPreferencesScreen(onNavigate: (MoveFuelRoute) -> Unit) {
    MFScreenFrame(
        id = "FPL_009",
        title = "Cooking Preferences",
        subtitle = "Future meal planning kept separate from consumed food.",
        primaryLabel = "Continue",
        primaryRoute = MoveFuelRoute.FPL_010,
        secondaryLabel = "Back",
        secondaryRoute = MoveFuelRoute.FPL_008,
...
@Composable
private fun FPL009CookingPreferencesScreenPreview() {
    MoveFuelTheme { FPL009CookingPreferencesScreen {} }
}
