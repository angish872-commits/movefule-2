...
test("analysis and nutrition wave is server-only and does not seed provider data", async () => {
  const manifest = JSON.parse(await readFile(new URL("../../../migrations/analysis-nutrition-wave.v1.json", import.meta.url), "utf8")) as Manifest & {
